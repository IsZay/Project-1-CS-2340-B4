...
urlpatterns = [
    path('', views.index, name='gtMovies.index'), # this should have all of our movie lists together, then have a login button in the top right and a register button.
    ...
    path('about/', views.about, name='gtMovies.about'),
]
